    ...
    <header class="top-header">
      <div class="header-container">
        ...
        <div class="logo-section">
          <router-link to="/adopter" class="logo-link">
            <div class="logo">
        ...
        <nav class="main-nav">
          ...
          >
            <el-menu-item index="/adopter/pets" class="nav-item">
              <el-icon><View /></el-icon>
              <span class="nav-text">宠物查看</span>
            </el-menu-item>
            <el-menu-item index="/adopter/products" class="nav-item">
              <el-icon><ShoppingCart /></el-icon>
              <span class="nav-text">用品商城</span>
            </el-menu-item>
            <el-menu-item index="/adopter/adoption" class="nav-item">
              <el-icon><Document /></el-icon>
              <span class="nav-text">领养记录</span>
            </el-menu-item>
            <el-menu-item index="/adopter/community" class="nav-item">
